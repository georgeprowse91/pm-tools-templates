# Tutorial: Customize and Publish a Project Charter (Draft)
...
5. Open a PR for review using .github/pull_request_template.md.

Expected Outcomes
- A customized charter ready for stakeholder review.

Validation
- CI passes link checks; reviewers approve.
