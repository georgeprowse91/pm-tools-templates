...
| less-retrospective-template.md | retrospective | less |  | less-retrospective-template.md |
| less-sprint-planning-template.md | sprint planning | less |  | less-sprint-planning-template.md |
...
| resource-management-assessment-template.md | resource management assessment | general |  | resource-management-assessment-template.md |
| resource-management-plan-template.md | resource management plan | general |  | resource-management-plan-template.md |
| risk-assessment-template.md | risk assessment | general |  | risk-assessment-template.md |
| risk-management-assessment-template.md | risk management assessment | general |  | risk-management-assessment-template.md |
| risk-management-plan-template.md | risk management plan | general |  | risk-management-plan-template.md |
| risk-register-all-template.md | risk register | general | DUP-04 | risk-register-template.md |
| risk-register-template.md | risk register | general | DUP-04 | risk-register-template.md |
| roi-tracking-template.md | roi tracking | general |  | roi-tracking-template.md |
...
| sprint-planning-template.md | sprint planning | general | DUP-05 | sprint-planning-template.md |
| sprint-retrospective-all-template.md | sprint retrospective | general | DUP-06 | sprint-retrospective-template.md |
| sprint-retrospective-template.md | sprint retrospective | general | DUP-06 | sprint-retrospective-template.md |
| sprint-review-all-template.md | sprint review | general | DUP-07 | sprint-review-template.md |
| sprint-review-template.md | sprint review | general | DUP-07 | sprint-review-template.md |
| stakeholder-engagement-assessment-template.md | stakeholder engagement assessment | general |  | stakeholder-engagement-assessment-template.md |
| stakeholder-register-template.md | stakeholder register | general |  | stakeholder-register-template.md |
| status-report-all-template.md | status report | general | DUP-08 | status-report-template.md |
| status-report-template.md | status report | general | DUP-08 | status-report-template.md |
| team-charter-template.md | team charter | general |  | team-charter-template.md |
| team-performance-assessment-template.md | team performance assessment | general |  | team-performance-assessment-template.md |
