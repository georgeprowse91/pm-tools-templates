...
| [Stakeholder Register](templates/project-lifecycle/01-initiation/stakeholder-analysis/stakeholder-register-template-template-general.md) | Identify and analyze stakeholders (Traditional) | Initiating | Beginner |
...
**Initiating**
 ...
 - [Stakeholder Register](templates/project-lifecycle/01-initiation/stakeholder-analysis/stakeholder-register-template-template-general.md) - Stakeholder identification & analysis
...
| [Stakeholder Register](templates/project-lifecycle/01-initiation/stakeholder-analysis/stakeholder-register-template-template-general.md) | Initiating | Beginner | Stakeholder identification & analysis |
...
| [Hybrid Release Planning](/templates/hybrid/Templates/hybrid-release-planning-template-template-general.md) | Planning | Intermediate | Multi-methodology release planning |
| [Hybrid Team Management](/templates/hybrid/Templates/hybrid-team-management-template-template-general.md) | Executing | Intermediate | Cross-methodology team leadership |
...
- [LeSS Sprint Planning](templates/all/less-sprint-planning-template-template-general.md) - Multi-team sprint planning
- [Overall Product Backlog Management](templates/all/overall_product_backlog_template.md) - Large-scale backlog coordination
- [LeSS Retrospective](templates/all/less-retrospective-template-template-general.md) - Organization-wide improvement
...
✅ **Leading Practice Integration** - Built on Industry Standard, Agile, and industry best practices  
