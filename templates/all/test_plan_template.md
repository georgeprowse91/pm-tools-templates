...
These metrics align with the SAFe quality metrics as outlined in the [SAFe Metrics Dashboard](../../../../templates/all/metrics_dashboard_template.md) and will be reported regularly through our quality dashboard.
