...
Related Resources:
- [Governance Tools](../templates/role-based/project-manager/governance-tools/)
- [Decision Authority Matrix](../templates/role-based/project-manager/governance-tools/decision-authority.md)
