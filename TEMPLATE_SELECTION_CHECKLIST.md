...
*Save time and improve project outcomes by selecting templates that match your specific context.*
...
#### Team Size
- [ ] **Solo/Small (1-5 people)** → Focus on lightweight templates
- [ ] **Medium (5-20 people)** → Standard templates with moderate complexity
- [ ] **Large (20-100 people)** → Comprehensive templates with full documentation
- [ ] **Enterprise (100+ people)** → Full governance suite + integration tools

#### Project Duration
- [ ] **Sprint/Short (< 3 months)** → Essential templates only
- [ ] **Standard (3-12 months)** → Core PM lifecycle templates
- [ ] **Long (1-2 years)** → Full template suite + governance
- [ ] **Program (2+ years)** → Program management + portfolio tools

#### Industry Context
- [ ] **IT/Software** → [IT Specialization](industry-specializations/information-technology/)
- [ ] **Healthcare** → [Healthcare Templates](industry-specializations/healthcare-pharmaceutical/)
- [ ] **Finance** → [Financial Services](industry-specializations/financial-services/)
- [ ] **Construction** → [Construction & Engineering](industry-specializations/construction-engineering/)
- [ ] **General/Universal** → Use standard templates
...
**Good Template Selection Indicators:**
- [ ] Team adopted templates without resistance
- [ ] Stakeholders find reports useful and clear
- [ ] Templates save time rather than create work
- [ ] Information flows smoothly between templates
- [ ] Project outcomes improve measurably

**Warning Signs to Adjust:**
- [ ] Templates sit unused
- [ ] Team complains about complexity
- [ ] Stakeholders ask for different information
- [ ] Maintaining templates takes more time than project work
- [ ] Templates don't match your methodology
...
### Agile Pack (Scrum Teams)
**Templates adapted for agile methodology:**

1. [Sprint Planning Templates](methodology-frameworks/agile-scrum/sprint-management/)
...
**Complete Project Setup (6-8 hours):**
1. Project Charter (1 hour)
2. Stakeholder Analysis (1 hour)
3. Communication Plan (1.5 hours)
4. Risk Register (1 hour)
5. Work Breakdown Structure (2 hours)
6. Project Schedule (2 hours)
7. Budget/Resource Plan (1.5 hours)
...
- [ ] Team is new to PM processes
- [ ] Project is short-term or low-risk
- [ ] Organization prefers informal approaches
- [ ] Resources are limited

#### Consider Enhancing If:
- [ ] High-visibility or high-risk project
- [ ] Multiple stakeholder groups
- [ ] Regulatory or compliance requirements
- [ ] Complex technical integration needed
...
**Week 1**: Start with Project Charter + Status Report
**Week 2**: Add Communication Plan + Risk Register
**Week 3**: Implement stakeholder management
**Week 4**: Add methodology-specific templates
**Month 2+**: Customize and enhance based on experience
...
*This checklist is designed to save you time and improve project outcomes. Bookmark it for quick reference!*

**⭐ Star this repository** to help other project managers discover these resources!
